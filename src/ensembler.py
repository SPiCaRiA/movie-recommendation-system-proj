...
search_space = [
    ...
    Integer(1, 50, name='k_user_corr_iuf'),
    Integer(1, 50, name='k_user_cos')
]
...
if __name__ == '__main__':
    ...
    print(
        f'Best Parameters: w1={result.x[0]}, w2={result.x[1]}, w3={result.x[2]}, w4={result.x[3]}, k_corr={result.x[4]}, k_cos={result.x[5]}'
    )
